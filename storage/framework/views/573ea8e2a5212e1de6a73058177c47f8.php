                    ...
                    <tbody class="table-group-divider">
                        ...
                        <?php $__currentLoopData = $carreras; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(url('carreras',[$row])); ?>" class="btn btn-warning"><i class="fa-solid fa-edit"></i></a>
                                </td>
                                <td>
                                    <form method="POST" action="<?php echo e(url('carreras',[$row])); ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frmCarreras" method="POST" action="<?php echo e(url('carreras')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laralumno\resources\views/carreras.blade.php ENDPATH**/ ?>